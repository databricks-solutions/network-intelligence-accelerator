/* Chapter 0 — Sionna RF Agent. A scripted, cinematic showcase:
   ...
   (public cell-site data); KPIs and configs are illustrative. */
...
async function onMapLoad() {
  ...
  map.addLayer({
    ...
    paint: {
      ...
      "circle-color": ["match", ["get", "type"], "NR", "#c4157e", "LTE", "#22d3ee", "#6b7a99"],
    },
  });
  map.addLayer({
  ...
  map.addLayer({ id: "sector-fill", type: "fill", source: "sector",
    paint: { "fill-color": "#c4157e", "fill-opacity": 0 } });
...
function reset() {
  ...
  paint("sector-fill", "fill-color", "#c4157e");
